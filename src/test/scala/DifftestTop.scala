...
class DifftestTop extends Module {
  ...
  val difftest_matrix_csr_state = DifftestModule(new DiffMatrixCSRState, dontCare = true)
  ...
  val difftest_matrix_store_event = DifftestModule(new DiffMatrixStoreEvent, dontCare = true)
